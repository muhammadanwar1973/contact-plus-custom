          ...
          <table width="300" border="0" cellspacing="2" cellpadding="2">
            <tr class="labels">
              ...
              <td nowrap="nowrap"><label for="tbOldPass"></label>
                <input type="password" name="textFields" id="textFields" class="textFields" /></td>
            </tr>
            <tr class="labels">
              <td nowrap="nowrap">New Password</td>
              <td nowrap="nowrap"><input type="password" name="textFields" id="textFields" class="textFields" /></td>
            </tr>
            <tr class="labels">
