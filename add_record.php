      ...
      <table width="960" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td align="center">
             ...
             <form name="add_contacts" method="post" action="act_add_record.php">
             <table width="300" border="0" cellspacing="2" cellpadding="2">
              <tr class="labels">
              <td nowrap="nowrap">Fullname::</td>
              <td nowrap="nowrap"><label for="tbFN"></label>
                <input type="text" name="tbFN" id="tbFN" class="textFields" /></td>
            </tr>
            <tr class="labels">
              <td nowrap="nowrap">Company:</td>
              <td nowrap="nowrap"><input type="text" name="tbCompany" id="tbCompany" class="textFields" /></td>
            </tr>
            
<tr class="labels">
              <td nowrap="nowrap">Designation:</td>
              <td nowrap="nowrap"><input type="text" name="tbDesignation" id="tbDesignation" class="textFields" /></td>
            </tr>
            
            <tr class="labels">
              <td nowrap="nowrap">Email</td>
              <td nowrap="nowrap"><input type="text" name="tbEmail" id="tbEmail" class="textFields" /></td>
            </tr>
            <tr class="labels">
              <td nowrap="nowrap">Phone</td>
              <td nowrap="nowrap"><input type="text" name="tbPhone" id="tbPhone" class="textFields" /></td>
            </tr>
            <tr class="labels">
              <td nowrap="nowrap">Mobile</td>
              <td nowrap="nowrap"><input type="text" name="tbMobile" id="tbMobile" class="textFields" /></td>
            </tr>
            <tr class="labels">
              <td nowrap="nowrap">Address</td>
              <td nowrap="nowrap"><label for="tbAddress"></label>
                <textarea name="tbAddress" id="tbAddress" cols="39" rows="5"></textarea></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td align="right"><input type="submit" name="button" id="button" value="Submit Record" class="btns" />
                <input type="reset" name="button2" id="button2" value="Cancel" class="btns" /></td>
            </tr>
      </table>
      </form>
       </td>
