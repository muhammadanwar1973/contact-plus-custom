    ...
    <td align="center"><table width="960" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="960" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td align="center">
              <form name="register_form" id="register_form" method="POST" action="act_index.php" ">
                   <table width="300" border="0" cellspacing="2" cellpadding="2">
              <tr class="labels">
              <td>Username:</td>
              <td><label for="tbUsername"></label>
                <input type="text" name="textFields" id="textFields" class="textFields" /></td>
            </tr>
            <tr class="labels">
              <td>Password:</td>
              <td><input type="password" name="textFields" id="textFields" class="textFields" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
