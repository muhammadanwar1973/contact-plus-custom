		...
		<table width="300" border="0" cellspacing="2" cellpadding="2">
            <tr class="labels">
              ...
              <td nowrap="nowrap"><label for="tbFN"></label>
                <input type="text" name="fullname" id="fullname" class="fullname" /></td>
            </tr>
            <tr class="labels">
              <td nowrap="nowrap">Country:</td>
              <td nowrap="nowrap"><input type="text" name="country" id="country" class="country" /></td>
            </tr>
            <tr class="labels">
              <td nowrap="nowrap">City:</td>
              <td nowrap="nowrap"><input type="text" name="city" id="city" class="city" /></td>
            </tr>
            <tr class="labels">
              <td nowrap="nowrap">Email:</td>
              <td nowrap="nowrap"><input type="text" name="email" id="email" class="email" /></td>
            </tr>
            <tr class="labels">
              <td nowrap="nowrap">Password:</td>
              <td nowrap="nowrap"><input type="password" name="password" id="password" class="password" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
